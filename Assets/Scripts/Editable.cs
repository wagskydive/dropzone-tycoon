...
public class Editable : MonoBehaviour
{
    ...
    public virtual void AssignSkillNode(string skillName, SkillNodeRuntimeOld skillNode)
    {
        Unsubscribe(OnEdited);
    }

    public virtual void AssignItemNode(string itemName, ItemNodeRuntimeOld itemNode)
    {
        Unsubscribe(OnEdited);
    }
