...
{
    public event Action<ItemNodeRuntimeOld> OnConfirmButtonClick;
    ...
    public ItemNodeRuntimeOld currentItemNode;
    ...
    public override void AssignItemNode(string itemName, ItemNodeRuntimeOld ItemNode)
    {
