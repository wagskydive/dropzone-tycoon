...
namespace CharacterLogic
{
    ...
    {
        public static void TickActiveCharacters(CharacterDataHolder characterHolder, float currentTime)
        {
            TickCharacterList(characterHolder, characterHolder.ActiveCharacters, currentTime);
        }
